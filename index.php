...
<div class="box-image">
  	<div class="single-page-img"></div>
  	 <div class="box-text">
    	<h2><?php esc_html_e( 'Blog Post', 'mehndi-tattoo-artist' ); ?></h2>  
    </div> 
</div>
<div class="container">
	<main id="tp_content" role="main">
		<div id="primary" class="content-area">
			<?php
	        $mehndi_tattoo_artist_sidebar_layout = get_theme_mod( 'mehndi_tattoo_artist_sidebar_post_layout','right');
	        if($mehndi_tattoo_artist_sidebar_layout == 'left'){ ?>
		        <div class="row m-0">
		        ...
		        <div class="clearfix"></div>
		    <?php }else if($mehndi_tattoo_artist_sidebar_layout == 'right'){ ?>
		        <div class="row m-0">
		          	<div class="col-lg-8 col-md-8 singlepage-main">
		    ...
		    <?php }else if($mehndi_tattoo_artist_sidebar_layout == 'full'){ ?>
		        <div class="full">		           
		            <?php if ( have_posts() ) : ?>
					<?php
					/* Start the Loop */
		    ...
		    <?php }else if($mehndi_tattoo_artist_sidebar_layout == 'three-column'){ ?>
		        <div class="row m-0">
		    ...
		    <?php }else if($mehndi_tattoo_artist_sidebar_layout == 'four-column'){ ?>
		        <div class="row m-0">
		          	<div class="col-lg-3 col-md-3" id="theme-sidebar"><?php get_sidebar(); ?></div>
		    ...
		    <?php }else if($mehndi_tattoo_artist_sidebar_layout == 'grid'){ ?>
		        <div class="row m-0">
